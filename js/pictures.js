...
(function () {
  ...
  var getComments = function (comments) {
    ...
    for (var i = 0; i < comments.length; i++) {
      ...
      img.src = 'img/avatar-' + comments.avatar + '.svg';
      img.alt = comments.name;
      img.width = 35;
      img.height = 35;
      p.classList.add('social__text');
      p.textContent = comments.messasge;
      li.appendChild(img);
      li.appendChild(p);
  ...
  var renderPictures = function (pictures) {
    ...
    for (var i = 0; i < pictures.length; i++) {
      ...
      pictureElement.querySelector('.picture__comments').textContent = pictures[i].comments.length - 1;
  ...
  var renderBigPicture = function (picture) {
    ...
    var renderComments = function () {
      var commentsElements = getComments(picture.comments);
  ...
  var showBigPicture = function (pictureSrc) {
    renderBigPicture(pictureSrc);
...
//   var setup = function () {
//     var onError = window.util.onError;
//     window.load(getPicturesDOM, onError);
//     hideCommentsCounter();
//     hideCommentsLoader();
//   };
//
